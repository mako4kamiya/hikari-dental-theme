...
/**
 * HikariDentalTheme's functions and definitions
 *
 * @package HikariDentalTheme
 * @since HikariDentalTheme 1.0
 */
...
if ( ! function_exists( 'HikariDentalTheme_setup' ) ) :
	...
	function HikariDentalTheme_setup() {
		 ...
		 */
		load_theme_textdomain( 'HikariDentalTheme', get_template_directory() . '/languages' );
