 ...
 * 02. ヘッドタグ（wp_head）内の各種設定追加
 * 03. テーマサポート設定 (Theme Supports)
 * 04. 管理画面のカスタマイズ (Admin Customizes)
 * 05. カスタム投稿タイプの追加 (Custom Post Types)
 * 06. ショートコードの追加 (Shortcodes)
 * 07. ページに応じたテキストの取得 (Dynamic Texts)
 * 08. その他のカスタマイズ (Other Customizes)
 */
...
/* ==========================================================================
   02. ヘッドタグ（wp_head）内の各種設定追加
   ========================================================================== */
function my_theme_add_head_meta() {
	// フォントの事前接続
	echo '<link rel="preconnect" href="https://fonts.googleapis.com">';
	echo '<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>';
	// Safariタブカラーの設定
	echo '<meta name="theme-color" content="#F4F1EC">';
}
add_action('wp_head', 'my_theme_add_head_meta');
