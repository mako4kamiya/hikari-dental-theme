    ...
    <section id="greeting">
        <div class="container">
            <div class="inner_container">
                <div class="headings">
                    <h2 class="text-style-h2">院長挨拶</h2>
                </div>
                <div class="greeting-message">
                    <div>
                        ...
                        <p class="text-style-p-regular">
                            当院では、患者さま一人ひとりのお悩みに寄り添い、安心して通い続けていただける歯科医院を目指しています。 
                            歯科治療に対して不安や緊張を感じる方も多いため、丁寧なカウンセリングとわかりやすい説明を大切にし、納得して治療を受けていただけるよう心がけています。
                        </p>
                        <p class="text-style-p-regular">
                            また、お口の健康は日々の生活の質にも大きく関わります。地域の皆さまが長く健康なお口を保てるよう、予防歯科にも力を入れ、安心して相談できる身近な歯科医院でありたいと考えています。
                        </p>
                        <p>
                ...
                <div class="director-history">
                    ...
                    <dl class="text-style-p-regular">
                        <div class="row">
                            <dt>2010年</dt><dd>○○大学歯学部<br><span>卒業</span></dd>
                        </div>
                        <div class="row">
                            <dt>2011年</dt><dd>○○大学歯学部附属病院<br>臨床研修<br><span>修了</span></dd>
                        </div>
                        <div class="row">
                            <dt>2012年</dt><dd>医療法人〇〇会<br>○○歯科クリニック<br><span>勤務</span></dd>
                        </div>
                        <div class="row">
                            <dt>2026年</dt><dd>ひかりデンタルクリニック<br><span>開院</span></dd>
                        </div>
                    </dl>
                </div>
            </div>
